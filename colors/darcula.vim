...
hi Folded ctermfg=244 ctermbg=235 cterm=NONE guifg=#747474 guibg=#2b2b2b gui=NONE

hi Normal ctermfg=188 ctermbg=235 cterm=NONE guifg=#a9b7c6 guibg=#2b2b2b gui=NONE
hi EndOfBuffer ctermfg=235 ctermbg=235 cterm=NONE guifg=#2b2b2b guibg=#2b2b2b gui=NONE
...
hi Comment ctermfg=244 ctermbg=NONE cterm=NONE guifg=#747474 guibg=NONE gui=none
...
hi String ctermfg=65 ctermbg=NONE cterm=NONE guifg=#629255 guibg=NONE gui=NONE
...
hi htmlTag ctermfg=222 ctermbg=NONE cterm=NONE guifg=#F9C26B guibg=NONE gui=NONE
hi htmlEndTag ctermfg=222 ctermbg=NONE cterm=NONE guifg=#F9C26B guibg=NONE gui=NONE
hi htmlTagName ctermfg=222 ctermbg=NONE cterm=NONE guifg=#F9C26B guibg=NONE gui=NONE
...
hi rubyStringDelimiter ctermfg=65 ctermbg=NONE cterm=NONE guifg=#629255 guibg=NONE gui=NONE
...
hi rubyRegexp ctermfg=65 ctermbg=NONE cterm=NONE guifg=#629255 guibg=NONE gui=NONE
hi rubyRegexpDelimiter ctermfg=65 ctermbg=NONE cterm=NONE guifg=#629255 guibg=NONE gui=NONE
...
hi erubyComment ctermfg=244 ctermbg=NONE cterm=NONE guifg=#747474 guibg=NONE gui=italic
hi erubyRailsMethod ctermfg=59 ctermbg=NONE cterm=bold guifg=#3c4c72 guibg=NONE gui=bold

" Extra js highlighting.
hi jsFuncName ctermfg=222 ctermbg=NONE cterm=NONE guifg=#F9C26B guibg=NONE gui=NONE
...
hi jsFuncCall ctermfg=222 ctermbg=NONE cterm=NONE guifg=#F9C26B guibg=NONE gui=NONE
hi jsComment ctermfg=244 ctermbg=NONE cterm=NONE guifg=#747474 guibg=NONE gui=none
hi jsBlockComment ctermfg=65 ctermbg=NONE cterm=NONE guifg=#629255 guibg=NONE gui=NONE
hi jsDocTags ctermfg=65 ctermbg=NONE cterm=bold guifg=#629255 guibg=NONE gui=bold
hi jsDocType ctermfg=65 ctermbg=NONE cterm=bold guifg=#629255 guibg=NONE gui=bold
...
hi JavaScriptFuncName ctermfg=222 ctermbg=NONE cterm=NONE guifg=#F9C26B guibg=NONE gui=NONE
hi JavaScriptFunction ctermfg=172 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=bold
"hi JavaScriptNoise ctermfg=222 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=bold
hi JavaScriptFuncCall ctermfg=222 ctermbg=NONE cterm=NONE guifg=#F9C26B guibg=NONE gui=NONE
hi JavaScriptLineComment ctermfg=244 ctermbg=NONE cterm=NONE guifg=#747474 guibg=NONE gui=NONE
hi JavaScriptComment ctermfg=65 ctermbg=NONE cterm=NONE guifg=#629255 guibg=NONE gui=italic
hi JavaScriptBlockComment ctermfg=65 ctermbg=NONE cterm=NONE guifg=#629255 guibg=NONE gui=italic
hi JavaScriptDocTags ctermfg=65 ctermbg=NONE cterm=bold guifg=#629255 guibg=NONE gui=bold
hi JavaScriptDocType ctermfg=65 ctermbg=NONE cterm=bold guifg=#629255 guibg=NONE gui=bold
hi JavaScriptFunctionKey ctermfg=222 ctermbg=NONE cterm=bold guifg=#cc7832 guibg=NONE gui=bold
hi JavaScriptCommonJs ctermfg=222 ctermbg=NONE cterm=bold guifg=#cc7832 guibg=NONE gui=bold
"hi JavaScriptParen ctermfg=222 ctermbg=NONE cterm=bold guifg=#cc7832 guibg=NONE gui=bold
hi JavaScriptParen ctermfg=188 ctermbg=235 cterm=NONE guifg=#a9b7c6 guibg=#2b2b2b gui=NONE
...
hi JavaScriptObjectKey ctermfg=103 ctermbg=NONE cterm=bold guifg=#9676ac guibg=NONE gui=bold
hi JavaScriptGlobalObjects ctermfg=103 ctermbg=NONE cterm=bold guifg=#9676ac guibg=NONE gui=bold
hi JavaScriptIdentifier ctermfg=103 ctermbg=NONE cterm=bold guifg=#9676ac guibg=NONE gui=bold
...
hi jadePipedText ctermfg=65 ctermbg=NONE cterm=NONE guifg=#629255 guibg=NONE gui=NONE
...
hi coffeeObjAssign ctermfg=222 ctermbg=NONE cterm=NONE guifg=#F9C26B guibg=NONE gui=NONE
hi coffeeSpecialVar ctermfg=188 ctermbg=235 cterm=NONE guifg=#a9b7c6 guibg=#2b2b2b gui=NONE

" Extra Java highlighting.
hi javaAnnotation ctermfg=222 ctermbg=NONE cterm=NONE guifg=#F9C26B guibg=NONE gui=NONE
hi javaTypeDef ctermfg=222 ctermbg=NONE cterm=NONE guifg=#F9C26B guibg=NONE gui=NONE
"hi javaOperator ctermfg=222 ctermbg=NONE cterm=NONE guifg=#F9C26B guibg=NONE gui=NONE

" Extra VIM highlighting.
hi vimOption ctermfg=222 ctermbg=NONE cterm=NONE guifg=#F9C26B guibg=NONE gui=NONE
hi vimUserFunc ctermfg=222 ctermbg=NONE cterm=NONE guifg=#F9C26B guibg=NONE gui=NONE
...
hi PmenuSbar  ctermfg=NONE ctermbg=24 guifg=NONE guibg=#747474
...
hi NonText ctermfg=244 ctermbg=NONE cterm=NONE guifg=#747474 guibg=NONE gui=none
